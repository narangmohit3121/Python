...
class Album(object):
    ...
    def add_song_to_album(self, song, position=None):
        is_song_present = is_item_present(self._tracks, song)
        if is_song_present is None:
            if position is None:
...
class Artist(object):
    ...
    def add_album(self, album):
        is_album_present = is_item_present(self._albums, album)
        if is_album_present is None:
...
def is_item_present(item_list: list, item: object):
    ...
    with open('albums.txt', 'r') as albums:
        ...
        for line in albums:
            ...
            if new_album is None:
                ...
                new_album = Album(album_field, year_field, new_artist)
                new_artist.add_album(new_album)
                print(new_artist.albums)
            new_album.add_song_to_album(song_field)
